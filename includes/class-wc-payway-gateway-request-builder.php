	...
	public function set_checkout_form_data( $post_data ) {
		...
		$this->checkout_posted_data = array(
			...
			'token' => isset($post_data['payway_gateway_cc_token'])
				? sanitize_text_field($post_data['payway_gateway_cc_token'])
				: false,
			'bin' => isset($post_data['payway_gateway_cc_bin'])
				? sanitize_text_field($post_data['payway_gateway_cc_bin'])
				: false,
			'last_digits' => isset($post_data['payway_gateway_cc_last_digits'])
				? sanitize_text_field($post_data['payway_gateway_cc_last_digits'])
				: false,
			'cc_type' => isset($post_data['payway_gateway_cc_type'])
				? sanitize_text_field($post_data['payway_gateway_cc_type'])
				: false,
			'door_number'=> isset($post_data['payway_gateway_cc_holder_door_number'])
				? sanitize_text_field($post_data['payway_gateway_cc_holder_door_number'])
				: false,
			'device_fingerprint' => isset($post_data['payway_gateway_device_fingerprint'])
				? sanitize_text_field($post_data['payway_gateway_device_fingerprint'])
				: false
